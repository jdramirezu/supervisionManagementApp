                    ...
                    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="mt-2 flex items-center gap-x-3">
                                <img src={selectedEmployee.picture ? `${selectedEmployee.picture}` : `https://robohash.org/${selectedEmployee.id}?200x200`} alt="Employee's name" className="size-40 rounded-full bg-white"/>
                            </div>
                        </div>
                        <div className="sm:col-span-1">
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="mt-2 flex items-center gap-x-3">   
                                ...
                                <a href={`${selectedEmployee.CV}`} target="_blank" rel="noopener noreferrer" ><label
                                    htmlFor="CV"
